...
urlpatterns = [
    ...
    path('edit/order', views.publications_edit_order,
         name='publications_edit_order'),
    path('edit/description', views.publications_description_edit,
         name='publications_description_edit'),
]
